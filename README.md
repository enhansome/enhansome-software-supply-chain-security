...
* [mandiant/flare-floss: FLARE Obfuscated String Solver uses advanced static analysis to automatically extract and deobfuscate strings from binaries, useful for analyzing suspicious artifacts and identifying hidden behaviors](https://github.com/mandiant/flare-floss) ⭐ 4,148 | 🐛 117 | 🌐 Python | 📅 2026-09-13
* [betterleaks/betterleaks: High-performance secrets detection tool with CEL-based contextual filtering, secret validation, and token efficiency filtering to reduce false positives](https://github.com/betterleaks/betterleaks) ⭐ 1,927 | 🐛 101 | 🌐 Go | 📅 2026-09-12
...
* [guacsec/guac: GUAC aggregates software security metadata into a high fidelity graph database.](https://github.com/guacsec/guac) ⭐ 1,541 | 🐛 96 | 🌐 Go | 📅 2026-09-12
* [mongodb/kingfisher: High-performance secret scanner that detects and validates secrets by testing against external systems](https://github.com/mongodb/kingfisher) ⭐ 1,230 | 🐛 12 | 🌐 Rust | 📅 2026-09-09, reducing false positives through entropy analysis and real-time verification across AWS, Azure, GCP, and other platforms
...
* [ossf/package-analysis: Open Source Package Analysis](https://github.com/ossf/package-analysis) ⭐ 911 | 🐛 85 | 🌐 Go | 📅 2026-09-04 and [ossf/package-feeds: Feed parsing for language package manager updates](https://github.com/ossf/package-feeds) ⭐ 91 | 🐛 33 | 🌐 Go | 📅 2026-06-01
  * Also [Argo Security Automation with OSS-Fuzz](https://blog.argoproj.io/argo-security-automation-with-oss-fuzz-da38c1f86452), [Improving Security by Fuzzing the CNCF landscape](https://www.cncf.io/blog/2022/06/28/improving-security-by-fuzzing-the-cncf-landscape/) and [google/oss-fuzz: OSS-Fuzz - continuous fuzzing for open source software.](https://github.com/google/oss-fuzz) ⭐ 12,645 | 🐛 766 | 🌐 Shell | 📅 2026-09-11
  * For Node.js: [CodeIntelligenceTesting/jazzer.js: Coverage-guided, in-process fuzzing for the Node.js](https://github.com/CodeIntelligenceTesting/jazzer.js) ⭐ 356 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-14
...
* [praetorian-inc/titus: High-performance secrets scanner with 487 detection rules for API keys, tokens, and credentials across hundreds of services, featuring live secret validation and available as CLI, Go library, and browser extensions](https://github.com/praetorian-inc/titus) ⭐ 698 | 🐛 6 | 🌐 Go | 📅 2026-09-11
* [chainguard-dev/malcontent: Static analysis tool for detecting supply chain attacks in container images and artifacts through behavioral pattern matching and anomaly detection](https://github.com/chainguard-dev/malcontent) ⭐ 675 | 🐛 10 | 🌐 YARA | 📅 2026-09-14
...
* [safedep/pmg: Package Manager Guard wraps package managers (npm, pip, poetry, uv, etc.) to block malicious packages at install time using SafeDep's realtime malware analysis with OS-native sandbox enforcement (default-deny access control) to protect against supply chain attacks](https://github.com/safedep/pmg) ⭐ 513 | 🐛 37 | 🌐 Go | 📅 2026-09-14 ([sandbox docs](https://github.com/safedep/pmg/blob/main/docs/sandbox.md) ⭐ 513 | 🐛 37 | 🌐 Go | 📅 2026-09-14)
...
* [AppThreat/blint: BLint is a Binary Linter to check the security properties, and capabilities in your executables. It is powered by lief.](https://github.com/AppThreat/blint) ⭐ 455 | 🐛 41 | 🌐 Python | 📅 2026-09-13
...
* [ocicl/ocicl: ASDF system package manager for Common Lisp](https://github.com/ocicl/ocicl) ⭐ 312 | 🐛 25 | 🌐 Common Lisp | 📅 2026-09-14 - all packages managed by ocicl have their signatures stored in the Rekor transparency log
...
* For inputs acquired e.g., via `curl`:
  ...
  * [Friends don't let friends Curl | Bash](https://sysdig.com/blog/friends-dont-let-friends-curl-bash/)
    * And the quite interesting [Enable packaging of curl|bash and other wild stuff. by jordansissel · Pull Request #1957 · jordansissel/fpm](https://github.com/jordansissel/fpm/pull/1957#issuecomment-1304978342) ⭐ 11,505 | 🐛 790 | 🌐 Ruby | 📅 2026-08-26
...
* [TaptuIT/awesome-devsecops: Curating the best DevSecOps resources and tooling.](https://github.com/TaptuIT/awesome-devsecops#dependency-management) ⭐ 1,728 | 🐛 43 | 📅 2024-08-02
...
* [anchore/syft: CLI tool and library for generating a Software Bill of Materials from container images and filesystems](https://github.com/anchore/syft) ⭐ 9,557 | 🐛 648 | 🌐 Go | 📅 2026-09-11 from [Software supply chain security solutions • Anchore](https://anchore.com/)
...
* [DefectDojo/django-DefectDojo: DefectDojo is a DevSecOps and vulnerability management tool.](https://github.com/DefectDojo/django-DefectDojo) ⭐ 4,937 | 🐛 225 | 🌐 Python | 📅 2026-09-14
...
* [DependencyTrack/dependency-track: Dependency-Track is an intelligent Component Analysis platform that allows organizations to identify and reduce risk in the software supply chain.](https://github.com/DependencyTrack/dependency-track) ⭐ 4,198 | 🐛 1,090 | 🌐 Java | 📅 2026-09-14
  * [Good read on Dependency-Track](https://tomalrichblog.blogspot.com/2022/06/the-first-complete-sbom-tool.html?m=1)

* [e-m-b-a/emba: Security analyzer for firmware of embedded devices, supporting static and dynamic analysis via emulation, SBOM generation, and vulnerability reporting](https://github.com/e-m-b-a/emba) ⭐ 3,658 | 🐛 18 | 🌐 Shell | 📅 2026-09-14

* [nexB/scancode-toolkit: ScanCode detects licenses, copyrights, package manifests & dependencies and more by scanning code ... to discover and inventory open source and third-party packages used in your code.](https://github.com/nexB/scancode-toolkit) ⭐ 2,622 | 🐛 1,692 | 🌐 Python | 📅 2026-09-11

* [oss-review-toolkit/ort: A suite of tools to assist with reviewing Open Source Software dependencies.](https://github.com/oss-review-toolkit/ort) ⭐ 2,083 | 🐛 326 | 🌐 Kotlin | 📅 2026-09-14
...
* [AppThreat/cdxgen: Generates CycloneDX Software Bill of Materials (SBOM) for many languages and package managers including Java, JavaScript, Python, Go, Rust, Ruby, PHP, and more](https://github.com/AppThreat/cdxgen) ⭐ 1,067 | 🐛 420 | 🌐 JavaScript | 📅 2026-09-13
...
* [kubernetes-sigs/bom: A utility to generate SBOM for Kubernetes projects, supporting SPDX format with file checksums, package information, and license data](https://github.com/kubernetes-sigs/bom) ⭐ 466 | 🐛 6 | 🌐 Go | 📅 2026-09-14
...
* [trailofbits/it-depends: A tool to automatically build a dependency graph and Software Bill of Materials (SBOM) for packages and arbitrary source code repositories.](https://github.com/trailofbits/it-depends) ⭐ 412 | 🐛 8 | 🌐 Python | 📅 2026-09-14
...
* [Trusera/ai-bom: AI Bill of Materials generator for agent workflows](https://github.com/Trusera/ai-bom) ⭐ 328 | 🐛 15 | 🌐 Python | 📅 2026-05-24, scanning n8n, LangGraph, and CrewAI workflows for AI components and generating SBOM output in CycloneDX and SPDX formats
...
* [fosslight/fosslight: FOSSLight is an integrated open source management system that supports the open source software lifecycle, including dependency analysis, license compliance, and SBOM generation.](https://github.com/fosslight/fosslight) ⭐ 202 | 🐛 38 | 🌐 Java | 📅 2026-09-14 See [fosslight.org](https://fosslight.org/)

* [Lab700xOrg/aisbom: Static malware and license scanner for ML model files](https://github.com/Lab700xOrg/aisbom) ⭐ 77 | 🐛 4 | 🌐 Python | 📅 2026-09-14, disassembling Pickle bytecode and parsing SafeTensors/GGUF binary headers to detect RCE-capable payloads and license risks before model load; generates CycloneDX/SPDX SBOMs and supports remote HTTP-range scanning of Hugging Face models with no weights downloaded.
...
* [guacsec/trustify](https://github.com/guacsec/trustify) ⭐ 70 | 🐛 88 | 🌐 Rust | 📅 2026-09-14 provides a searchable abstraction over CycloneDX/SPDX SBOMs, cross-referencing against security advisories to identify vulnerabilities. See [docs](https://docs.trustification.dev/trustify/index.html)
...
* [Mend SCA SBOM](https://www.mend.io/sbom/), [Mend Bolt: Find and Fix Open Source vulnerabilities](https://www.mend.io/free-developer-tools/bolt/) and [Whitesource Renovate: Automated Dependency Updates](https://www.whitesourcesoftware.com/free-developer-tools/renovate/)
  * [renovatebot/renovate: Universal dependency update tool that fits into your workflows.](https://github.com/renovatebot/renovate) ⭐ 22,490 | 🐛 1,318 | 🌐 TypeScript | 📅 2026-09-14
...
* **Nix-specific SBOM tools** for generating precise SBOMs from Nix derivations:
  * [tiiuae/sbomnix: Generates SBOMs for Nix derivations at the .drv level, attempting to reconstruct metadata and supporting both build-time and runtime pruning](https://github.com/tiiuae/sbomnix) ⭐ 320 | 🐛 10 | 🌐 Python | 📅 2026-09-10
...
* [envoy/DEPENDENCY\_POLICY.md at main · envoyproxy/envoy](https://github.com/envoyproxy/envoy/blob/main/DEPENDENCY_POLICY.md) ⭐ 28,917 | 🐛 1,858 | 🌐 C++ | 📅 2026-09-14
...
- [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 135 | 🐛 149 | 🌐 TypeScript | 📅 2026-09-14 - Multi-cluster Kubernetes dashboard with integrated supply chain security (SBOM, SLSA, Sigstore/Cosign, Kyverno policy), CNCF Sandbox project.
...
* [aquasecurity/trivy: Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues](https://github.com/aquasecurity/trivy) ⭐ 37,900 | 🐛 270 | 🌐 Go | 📅 2026-09-11
* [anchore/grype: A vulnerability scanner for container images and filesystems](https://github.com/anchore/grype) ⭐ 12,876 | 🐛 411 | 🌐 Go | 📅 2026-09-11
...
* [future-architect/vuls: Agent-less vulnerability scanner for Linux, FreeBSD, Container, WordPress, Programming language libraries, Network devices](https://github.com/future-architect/vuls) ⭐ 12,255 | 🐛 91 | 🌐 Go | 📅 2026-09-14
* [trickest/cve: Gather and update all available and newest CVEs with their PoC.](https://github.com/trickest/cve) ⭐ 8,066 | 🐛 21 | 🌐 HTML | 📅 2026-09-13
* [infobyte/faraday: Open Source Vulnerability Management Platform](https://github.com/infobyte/faraday) ⭐ 6,743 | 🐛 17 | 🌐 Python | 📅 2026-09-04 from [Faraday - Community v4 Release](https://faradaysec.com/community-v4/)
* [ossf/scorecard: Security Scorecards - Security health metrics for Open Source](https://github.com/ossf/scorecard) ⭐ 5,688 | 🐛 453 | 🌐 Go | 📅 2026-09-10, [OpenSSF Metrics](https://metrics.openssf.org/) and [ossf/security-reviews: A community collection of security reviews of open source software components.](https://github.com/ossf/security-reviews) ⭐ 101 | 🐛 15 | 🌐 Python | 📅 2024-02-29
  ...
  * Also see: [naveensrinivasan/scorecard-1000-critical-projects](https://github.com/naveensrinivasan/scorecard-1000-critical-projects) ⭐ 2 | 🐛 0 | 🌐 Go | 📅 2022-11-10, using the Scorecard API to analyze the top 1000 critical open source projects from the [Criticality Score](https://github.com/ossf/criticality_score) ⭐ 1,457 | 🐛 92 | 🌐 Go | 📅 2026-08-27 dataset
...
* [nexB/vulnerablecode: A work-in-progress towards a free and open vulnerabilities database and the packages they impact. And the tools to aggregate and correlate these vulnerabilities. Sponsored by NLnet https://nlnet.nl/project/vulnerabilitydatabase/ for https://www.aboutcode.org/ Chat at https://gitter.im/aboutcode-org/vulnerablecode](https://github.com/nexB/vulnerablecode) ⭐ 702 | 🐛 812 | 🌐 Python | 📅 2026-09-09
...
* [vulnerability-lookup/vulnerability-lookup: Vulnerability correlation platform with multi-source feeds](https://github.com/vulnerability-lookup/vulnerability-lookup) ⭐ 575 | 🐛 71 | 🌐 Python | 📅 2026-09-14 (NVD, GitHub, OSV, national databases), CVD management, sightings tracking, comments, bundles, and API for rapid lookup and cross-source correlation
* [noqcks/xeol: An end-of-life (EOL) package scanner for container images, systems, and SBOMs](https://github.com/noqcks/xeol) ⭐ 448 | 🐛 36 | 🌐 Go | 📅 2026-06-25
...
* [Exein-io/kepler: NIST-based CVE lookup store and API powered by Rust](https://github.com/Exein-io/kepler) ⭐ 140 | 🐛 10 | 🌐 Rust | 📅 2025-09-17
...
* [OSV](https://osv.dev/)
  * Tools: [google/osv-scanner: Vulnerability scanner written in Go which uses the data provided by https://osv.dev](https://github.com/google/osv-scanner) ⭐ 11,021 | 🐛 114 | 🌐 Go | 📅 2026-09-14
...
* [armosec/kubescape: Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning.](https://github.com/armosec/kubescape) ⭐ 11,730 | 🐛 44 | 🌐 Go | 📅 2026-09-14
  * Also: [kubescape Visual Studio Code extension](https://www.armosec.io/blog/find-kubernetes-security-issues-while-coding/)
* [aquasecurity/kube-bench: Checks whether Kubernetes is deployed according to security best practices as defined in the CIS Kubernetes Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,182 | 🐛 104 | 🌐 Go | 📅 2026-09-07 and [aquasecurity/kube-hunter: Hunt for security weaknesses in Kubernetes clusters](https://github.com/aquasecurity/kube-hunter) ⭐ 5,085 | 🐛 82 | 🌐 Python | 📅 2024-03-19
* [cloudquery/plugins/source/k8s/policies at main · cloudquery/cloudquery](https://github.com/cloudquery/cloudquery/tree/main/plugins/source/k8s/policies) ⭐ 6,520 | 🐛 166 | 🌐 Go | 📅 2026-09-14
...
* [Conftest](https://www.conftest.dev/examples/) allows to write tests against structured configuration data using the Open Policy Agent Rego query language: [here's an example](https://github.com/open-policy-agent/conftest/blob/master/examples/docker/policy/commands.rego) ⭐ 3,261 | 🐛 43 | 🌐 Go | 📅 2026-09-13
* [aquasecurity/trivy-operator: Kubernetes-native security toolkit that continuously scans the cluster for vulnerabilities, misconfiguration, secrets, and exposed sensitive information](https://github.com/aquasecurity/trivy-operator) ⭐ 1,939 | 🐛 219 | 🌐 Go | 📅 2026-09-13
...
* [stackrox/stackrox: The StackRox Kubernetes Security Platform performs a risk analysis of the container environment, delivers visibility and runtime alerts, and provides recommendations to proactively improve security by hardening the environment.](https://github.com/stackrox/stackrox) ⭐ 1,311 | 🐛 653 | 🌐 Go | 📅 2026-09-14
...
* [ossillate-inc/packj: The vetting tool 🚀 behind our large-scale security analysis platform to detect malicious/risky open-source packages](https://github.com/ossillate-inc/packj) ⭐ 692 | 🐛 14 | 🌐 Python | 📅 2026-09-14 and [Packj | A vetting tool to avoid "risky" packages](https://packj.dev/)
...
* [portieris/POLICIES.md at main · IBM/portieris](https://github.com/IBM/portieris/blob/main/POLICIES.md) ⭐ 345 | 🐛 60 | 🌐 Go | 📅 2026-09-11
* [cicd-sensor/cicd-sensor: eBPF-powered runtime security sensor for GitHub Actions and GitLab CI/CD pipelines, providing EDR-like visibility and detection of malicious process execution and supply chain attacks during builds](https://github.com/cicd-sensor/cicd-sensor) ⭐ 252 | 🐛 13 | 🌐 Go | 📅 2026-09-13 ([docs](https://cicd-sensor.github.io/))
* [avilum/secimport: eBPF-based module-level sandboxing for Python applications, enforcing syscall restrictions per Python module to mitigate risks from vulnerable or malicious dependencies](https://github.com/avilum/secimport) ⭐ 243 | 🐛 2 | 🌐 Python | 📅 2026-03-18
  * Or [Cargo Vet](https://mozilla.github.io/cargo-vet/) and [crev-dev/cargo-crev: A cryptographically verifiable code review system for the cargo (Rust) package manager.](https://github.com/crev-dev/cargo-crev) ⭐ 2,333 | 🐛 52 | 🌐 Rust | 📅 2026-07-21
  * Or [trailofbits/pip-audit: Audits Python environments and dependency trees for known vulnerabilities](https://github.com/trailofbits/pip-audit) ⭐ 1,362 | 🐛 62 | 🌐 Python | 📅 2026-09-09
    * And: [Use data-dist-info-metadata (PEP 658) to decouple resolution from downloading by cosmicexplorer · Pull Request #11111 · pypa/pip](https://github.com/pypa/pip/pull/11111) ⭐ 10,284 | 🐛 952 | 🌐 Python | 📅 2026-09-14
...
* [kusari-oss/darnit: Pluggable compliance audit framework generating cryptographic attestations and automating remediation for software engineering best practices including security, testing, build reproducibility, and governance](https://github.com/kusari-oss/darnit) ⭐ 22 | 🐛 72 | 🌐 Python | 📅 2026-09-13
...
* [asfaload/checksums: Repository holding checksums of internet artifacts to improve security of downloads by hosting duplicate verification points](https://github.com/asfaload/checksums) ⭐ 1 | 🐛 0 | 📅 2026-09-14
...
* Several [pre-commit](https://pre-commit.com/hooks.html) hooks allow vulnerability checking right before dependency ingestion time into the codebase
  * e.g., [pyupio/safety: Safety checks your installed dependencies for known security vulnerabilities](https://github.com/pyupio/safety) ⭐ 1,996 | 🐛 98 | 🌐 Python | 📅 2026-09-04
    * Or [npm-audit](https://docs.npmjs.com/cli/v8/commands/npm-audit)
      * And [lirantal/lockfile-lint: Lint an npm or yarn lockfile to analyze and detect security issues](https://github.com/lirantal/lockfile-lint) ⭐ 868 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-13
...
* Static analysis is often used at this stage in order to detect dependency acquisition, e.g.:
  ...
  * [DataDog/guarddog: GuardDog is a CLI tool to Identify malicious PyPI and npm packages](https://github.com/datadog/guarddog) ⭐ 1,206 | 🐛 29 | 🌐 Python | 📅 2026-09-08
...
* [KICS - Keeping Infrastructure as Code Secure](https://kics.io/)
  * `hadolint` rules on package installation, e.g., [hadolint/README.md at d16f342c8e70fcffc7a788d122a1ba602075250d · hadolint/hadolint](https://github.com/hadolint/hadolint/blob/d16f342c8e70fcffc7a788d122a1ba602075250d/README.md#rules) ⭐ 12,400 | 🐛 208 | 🌐 Haskell | 📅 2026-08-24
    * Also [dockerfile resource scans - checkov](https://www.checkov.io/5.Policy%20Index/dockerfile.html) from [bridgecrewio/checkov: Prevent cloud misconfigurations during build-time for Terraform, CloudFormation, Kubernetes, Serverless framework and other infrastructure-as-code-languages with Checkov by Bridgecrew.](https://github.com/bridgecrewio/checkov) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10
    * And: [aws-samples/automated-security-helper](https://github.com/aws-samples/automated-security-helper) ⭐ 694 | 🐛 16 | 🌐 Python | 📅 2026-09-141
...
* [analysis-tools-dev/static-analysis: ⚙️ A curated list of static analysis (SAST) tools for all programming languages, config files, build tools, and more.](https://github.com/analysis-tools-dev/static-analysis/) ⭐ 14,781 | 🐛 9 | 🌐 Rust | 📅 2026-09-13
...
* [keylime/keylime: A CNCF Project to Bootstrap & Maintain Trust on the Edge / Cloud and IoT](https://github.com/keylime/keylime) ⭐ 566 | 🐛 74 | 🌐 Python | 📅 2026-09-02
...
* [goharbor/harbor: Trusted cloud native registry project supporting content signing and verification, RBAC, and vulnerability scanning for OCI artifacts](https://github.com/goharbor/harbor) ⭐ 29,360 | 🐛 892 | 🌐 Go | 📅 2026-09-14
* [Allow using SSH keys to sign commits · Discussion #7744 · github/feedback](https://github.com/github/feedback/discussions/7744#discussioncomment-1794438) ⭐ 8,766 | 🐛 0 | 🌐 Ruby | 📅 2026-09-09
* [google/trillian: A transparent, highly scalable and cryptographically verifiable data store.](https://github.com/google/trillian) ⭐ 3,749 | 🐛 47 | 🌐 Go | 📅 2026-09-10
...
* [spiffe/spire: The SPIFFE Runtime Environment](https://github.com/spiffe/spire) ⭐ 2,531 | 🐛 119 | 🌐 Go | 📅 2026-09-13
* [stacklok/toolhive: MCP server deployment platform with Sigstore-based provenance verification and attestation support for container images and binaries](https://github.com/stacklok/toolhive) ⭐ 2,163 | 🐛 373 | 🌐 Go | 📅 2026-09-11
...
* [deislabs/ratify: Artifact Ratification Framework](https://github.com/deislabs/ratify) ⭐ 308 | 🐛 171 | 🌐 Go | 📅 2026-09-14
...
* [trustcheck](https://github.com/Halfblood-Prince/trustcheck) ⭐ 79 | 🐛 3 | 🌐 Python | 📅 2026-09-13 – Verify PyPI packages using attestations and provenance before installing them.
* [oras-project/artifacts-spec](https://github.com/oras-project/artifacts-spec/) ⚠️ Archived
* [Fraunhofer-SIT/charra: Proof-of-concept implementation of the "Challenge/Response Remote Attestation" interaction model of the IETF RATS Reference Interaction Models for Remote Attestation Procedures using TPM 2.0.](https://github.com/Fraunhofer-SIT/charra) ⭐ 42 | 🐛 0 | 🌐 C | 📅 2026-09-08
...
* [asfaload/asfaload: Open-source self-hostable multisignature sign-off solution for securing artifact downloads, container image validation, and deployment approval workflows with configurable m-of-n signature thresholds](https://github.com/asfaload/asfaload) ⭐ 16 | 🐛 29 | 🌐 Rust | 📅 2026-09-10 ([docs](https://asfaload.com/doc/))
  * [sigstore/helm-sigstore: Helm plugin for publishing and verifying signed Helm charts in the Rekor transparency log](https://github.com/sigstore/helm-sigstore) ⭐ 71 | 🐛 15 | 🌐 Go | 📅 2026-09-02 and [sigstore/helm-charts: Helm charts for deploying sigstore components in Kubernetes](https://github.com/sigstore/helm-charts) ⭐ 94 | 🐛 64 | 🌐 Go Template | 📅 2026-09-14
...
* Part of [sigstore](https://www.sigstore.dev/)
  * [sigstore/model-transparency: Signing and verification for ML model integrity and provenance via Sigstore](https://github.com/sigstore/model-transparency) ⭐ 244 | 🐛 52 | 🌐 Python | 📅 2026-09-14 - extends model supply chain security to ML artifacts
...
* [praetorian-inc/trajan: Multi-platform CI/CD security scanner for detecting pipeline configuration weaknesses across GitHub Actions, GitLab CI, Azure DevOps, Jenkins, and JFrog](https://github.com/praetorian-inc/trajan) ⭐ 185 | 🐛 5 | 🌐 Go | 📅 2026-09-13
...
* [CycloneDX/transparency-exchange-api: OWASP Transparency Exchange API (TEA) standard for exchanging SBOM and vulnerability information, standardized in ECMA TC54](https://github.com/CycloneDX/transparency-exchange-api) ⭐ 113 | 🐛 66 | 🌐 Shell | 📅 2026-09-10
...
* [securego/gosec: Go static analysis tool that detects security problems by scanning the Go AST, enforcing secure coding practices](https://github.com/securego/gosec) ⭐ 8,945 | 🐛 8 | 🌐 Go | 📅 2026-09-14
...
* [defenseunicorns/zarf: DevSecOps for Air Gap & Limited-Connection Systems. https://zarf.dev/](https://github.com/defenseunicorns/zarf) ⭐ 2,040 | 🐛 282 | 🌐 Go | 📅 2026-09-14
...
* [trailofbits/buttercup: AI-driven cyber reasoning system for automated vulnerability discovery and patching in open-source code repositories using fuzzing and multi-agent LLM-based patching](https://github.com/trailofbits/buttercup) ⭐ 1,700 | 🐛 61 | 🌐 Python | 📅 2026-08-31
...
* [rust-secure-code/cargo-auditable: Embed the Cargo dependency tree in your Rust binaries](https://github.com/rust-secure-code/cargo-auditable) ⭐ 852 | 🐛 17 | 🌐 Rust | 📅 2026-09-13, enabling vulnerability auditing of compiled Rust binaries with zero bookkeeping; supported by cargo-audit, Trivy, Grype, and other tools
...
* [knostic/OpenAnt: LLM-based vulnerability discovery tool for proactively finding verified security flaws while minimizing false positives and negatives, supporting Go, Python, JavaScript/TypeScript, C/C++, PHP, and Ruby](https://github.com/knostic/OpenAnt) ⭐ 748 | 🐛 23 | 🌐 Python | 📅 2026-09-13
...
* [chainloop-dev/chainloop: Chainloop is an open source software supply chain control plane, a single source of truth for artifacts plus a declarative attestation crafting process.](https://github.com/chainloop-dev/chainloop) ⭐ 582 | 🐛 16 | 🌐 Go | 📅 2026-09-12
...
* [SpecterOps/GitHound: BloodHound OpenGraph collector for GitHub mapping organizational structure, permissions, and roles into navigable attack-path graphs for security audits](https://github.com/SpecterOps/GitHound) ⭐ 146 | 🐛 9 | 🌐 PowerShell | 📅 2026-08-10
* [hermetoproject/hermeto: CLI tool that pre-fetches dependencies to enable hermetic builds with explicit, reproducible, and pinned dependencies for network-isolated container builds](https://github.com/hermetoproject/hermeto) ⭐ 107 | 🐛 91 | 🌐 Python | 📅 2026-09-11
...
* [dash14/buildcage: Restricts outbound network access during Docker builds per RUN step via SNI-based domain filtering, working as a drop-in BuildKit remote driver with ready-to-use GitHub Actions](https://github.com/dash14/buildcage) ⭐ 11 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-14
...
* [Security hardening for GitHub Actions](https://docs.github.com/en/actions/security-guides/security-hardening-for-github-actions)
  * And: [zizmor: Static analysis for GitHub Actions workflows to identify insecure CI/CD patterns](https://github.com/zizmorcore/zizmor) ⭐ 6,504 | 🐛 163 | 🌐 Rust | 📅 2026-09-11
  * And: [step-security/harden-runner: Security agent for GitHub-hosted runner: block egress traffic & detect code overwrite to prevent breaches](https://github.com/step-security/harden-runner) ⭐ 1,268 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-31
